...
exports.profileFixTokens = exports.getColors = exports.theme = void 0;
...
exports.theme = {
    ...
    colors: {
        ...
        givenNumber: "#000000",
        enteredNumber: "#1E90FF", // ✅ user-entered numbers (blue)
    ...
    darkColors: {
        ...
        givenNumber: "#ffffff",
        enteredNumber: "#90caf9", // ✅ user-entered numbers (blue in dark mode)
...
// ✅ Async theme handling
var cachedTheme = "light";
async_storage_1.default.getItem("appTheme").then(function (val) {
...
var getColors = function () {
    if (cachedTheme === "dark")
        return exports.theme.darkColors;
    if (cachedTheme === "blue")
        return exports.theme.blueColors;
    return exports.theme.colors;
};
exports.getColors = getColors;
// ===== Added for Profile screen fixes =====
exports.profileFixTokens = {
    colors: {
